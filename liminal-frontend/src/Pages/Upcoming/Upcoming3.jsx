import upcomingA from "/assets/upcoming3-a.jpeg";
import upcomingB from "/assets/upcoming3-b.jpeg";
import upcomingC from "/assets/upcoming3-c.jpeg";
import upcomingD from "/assets/upcoming3-d.jpeg";
import upcomingE from "/assets/upcoming3-e.jpeg";
              ...
              <div className="lg:w-10/12 sm:w-11/12 mx-auto px-3 pt-6">
                ...
                <div className="sm:flex justify-end sm:-translate-y-20 sm:translate-x-10">
                  <div className="bg-[#154434] text-white sm:inline-block p-5 sm:pr-20">
                    ...
                    <h2 className="sm:text-2xl text-xl">Boutique hotel | Paxos Islands</h2>
                  </div>
                </div>
              </div>
